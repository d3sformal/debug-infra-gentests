...
echo "N:PasswordGenerator::setLength" |  cargo r --release -- -vvvv --modmap "$modmaps" trace-calls -o "$fixpath/selection.bin" "$keepass/build/src/cli/keepassxc-cli" generate --length 13
